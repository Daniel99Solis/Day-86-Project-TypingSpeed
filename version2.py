# --------------------------- Typing Speed App Version 2 ------------------------------------- #
# In this version in some way I fixed the problem that some words jump to the other line because
# there wasn't enough space, and then they cut like in two words. So, in this version I added
# some code to avoid this problem and bad user experience by "justifying" the content on each line
from tkinter import *
